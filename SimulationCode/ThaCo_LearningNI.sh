...
cat  ThaCo_LearningNI.templ.py | sed "s/_interval_/$interval/;s/_nthreads_/$nthreads/;s/_isubset_/$isubset/g" >   ThaCo_LearningNI_sub${isubset}.py
python2   ThaCo_LearningNI_sub${isubset}.py >   ThaCo_LearningNI_sub${isubset}.log
