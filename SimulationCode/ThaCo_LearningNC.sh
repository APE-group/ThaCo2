...
cat  ThaCo_LearningNC.templ.py | sed "s/_interval_/$interval/;s/_nthreads_/$nthreads/;s/_isubset_/$isubset/g" >   ThaCo_LearningNC_sub${isubset}.py
python2   ThaCo_LearningNC_sub${isubset}.py >   ThaCo_LearningNC_sub${isubset}.log
