...
# Set save path
home = os.getcwd()
save_path = home +  '/../SimulationOutput/ThaCo_Homeostasis/set' + str(_isubset_) + '/'
...
nest.Connect(neur_exc, sd_exc[0:interval*n_exc_example*N_CLASSES], "one_to_one")
...
for i_train in range(0, interval*N_CLASSES):
...
np.save(save_path + 'Alpha' + str(_alpha_sleep_) + '_ClassAccuracy_Arr', ClassAccuracy_Arr)
np.save(save_path + 'Alpha' + str(_alpha_sleep_) + '_GroupAccuracy_Arr', GroupAccuracy_Arr)
np.save(save_path + 'Alpha' + str(_alpha_sleep_) + '_ReadoutAccuracy_Arr', ReadoutAccuracy_Arr)
np.save(save_path + 'Alpha' + str(_alpha_sleep_) + '_TimeSleep', TimeSleep)


conn_par_exc_exc = nest.GetConnections(neur_exc, neur_exc)
w_exc_exc = nest.GetStatus(conn_par_exc_exc, ["source", "target", "weight"])
name = save_path + 'Alpha' + str(_alpha_sleep_) + '_weights_PreSleep' + '.mat'
...
conn_par_exc_exc = nest.GetConnections(neur_exc, neur_exc)
w_exc_exc = nest.GetStatus(conn_par_exc_exc, ["source", "target", "weight"])
name = save_path + 'Alpha' + str(_alpha_sleep_) + '_weights_PostSleep_'  + '.mat'
sio.savemat(name, {'w_exc_exc': w_exc_exc})
...
name = save_path + 'Alpha' + str(_alpha_sleep_) + '_events' + '.mat'
